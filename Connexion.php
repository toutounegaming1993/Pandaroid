		...
		try
			{
				...
				if($verif==0)
				{
					...
					$erreur = 'Attention: e-mail ou mot de passe non correct';
				}	
			}
		catch(Exception $e) {
				echo $e->getMessage();
...
if (isset($_POST['valider2']) AND $_POST['valider2'] == 'Valider') {
	...
	$erreur2 = 'Une erreur est survenue: au moins un des champs est vide  Veuillez récommencer l\'opération';
	}
	...
	<body onLoad="loading()">
		<div id="contenu">
			...
			<div id="popup" class="hidden">
				...
				<form id = "popupup" action="connexion.php" method="post">
